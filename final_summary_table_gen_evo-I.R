...
for (f in list.files(path = ".", full.names = TRUE)){
  ...
  if(f %in% c("./All.lincRNAs.fa","./lincRNAs.overlapping.known.lincs.fa","./lincRNAs.with.CAGE.support.annotated.fa","./lincRNA.bed","./intersect_output2.txt")){
    ...
    write.table(merge4, file = "final_Summary_table_evolinc-I.tsv", row.names = F, col.names = T, quote = F, sep = "\t")
  ...
  else if(f %in% c("./All.lincRNAs.fa","./lincRNAs.overlapping.known.lincs.fa","./lincRNA.bed","./intersect_output2.txt")){
      ...
      merge2$gene <- as.character(merge2$gene)
  ...
  else if(f %in% c("./All.lincRNAs.fa","./lincRNAs.with.CAGE.support.annotated.fa","./lincRNA.bed")){
