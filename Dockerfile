...
ENV BINPATH /usr/bin
ENV EVOLINC https://upendra_35@bitbucket.org/upendra_35/evolinc_docker.git

RUN git clone $EVOLINC
...
RUN cd ..
# Bedops tool
wget -O- https://github.com/bedops/bedops/releases/download/v2.4.16/bedops_linux_x86_64-v2.4.16.tar.bz2 | tar jxvf -
# cpan
